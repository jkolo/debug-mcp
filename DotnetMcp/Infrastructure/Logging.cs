...
namespace DotnetMcp.Infrastructure;
...
{
    // Category names
    public const string DebugSession = "DotnetMcp.DebugSession";
    public const string ProcessDebugger = "DotnetMcp.ProcessDebugger";
    public const string Tools = "DotnetMcp.Tools";
